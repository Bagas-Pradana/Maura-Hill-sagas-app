...
@section('content')
    ...
    <section id="hero" class="relative w-full min-h-screen overflow-hidden">
        <div
            class="relative font-poppins font-semibold text-headline5 min-w-7xl bg-transparent sm:bg-sky-200 sm:text-2xl lg:text-headline4 md:min-w-96 md:mx-0 lg:w-full min-h-screen">
            <span id="form-title"
                class="absolute top-[5.75rem] sm:top-[5.75rem] lg:top-[7.3rem] right-14 sm:right-44 text-primary-500 transition-opacity animate-fadeOutIn">Selamat
                Datang</span>
            <span id="form-title2"
            ...
            <div
                ...
                <a href="#banner"
                    class=" text-neutral-50 mx-auto block font-poppins text-headline4 -rotate-90 font-semibold">⟨</a>
            </div>
        </div>
    </section>
    <!-- End Hero Section -->
    ...
    <section id="banner" class="pt-24 pb-12 min-h-screen flex items-center relative lg:pb-24">
        ...
        <div class="absolute bottom-2 left-1/2 -translate-x-1/2 animate-custom-pulse">
            ...
            <a href="#facility"
                class="text-primary-500 block text-headline4 -rotate-90 font-semibold">⟨</a>
        </div>
    </section>
    <!-- End Banner Section -->
    <!-- Article Section -->
    <section id="facility">
        <div
            class="border-y-4 py-[6.5rem] font-poppins bg-primary-500 sm:border-0 sm:border-b-4 sm:bg-primary-500">
            <h1
    ...
    <section id="social-media">
        <div
            class="font-poppins font-bold border-b-4 px-4 py-4 bg-transparent text-center h-[50vh] flex flex-col gap-y-2 items-center justify-center text-additional1 sm:text-headline4 md:text-headline3">
