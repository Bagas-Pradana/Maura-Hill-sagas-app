...
@section('content')
    ...
    <section id="hero" class="relative w-full">
        <div class="bg-shade-white min-h-[75vh] flex flex-row items-center justify-center">
            ...
            <span
                class="absolute text-primary-500 font-bold  text-headline4 md:text-headline2 lg:text-headline3 xl:text-headline2">Produk
                Kami</span>
            <div
                class="absolute flex flex-wrap -bottom-[4.5rem] md:-bottom-[5rem] lg:-bottom-[5.3rem] left-1/2 -translate-x-1/2 mb-24 w-full justify-center">
    ...
    <section id="banner-rumah-maura"
        class="bg-shade-white flex items-center min-h-screen relative px-8 sm:px-12 md:px-16 lg:p-20 py-20">
        <div
    ...
    <!-- Content Section-->
    <section id="house-content"
        class="bg-shade-white sm:bg-neutral-200 min-h-screen px-8 sm:px-12 md:px-16 lg:p-20 sm:py-16">
        <div
            class="bg-shade-white flex min-h-full justify-center items-center text-headline4 md:text-headline3 sm:text-center">
            <div
                class="w-full bg-shade-white border-primary-500 pb-10 sm:border-[3.5px] flex flex-col gap-y-8 sm:flex-row sm:flex-wrap justify-evenly md:justify-center lg:px-12">
                <!-- Button -->
                <div
                    class="pb-2 pt-10 flex justify-between gap-x-4 lg:gap-x-8 w-full sm:w-4/5 lg:w-full overflow-x-auto font-bold text-headline6 md:text-headline5 lg:text-headline4 px-0">
                    <button id="everest-button" type="button" id="rumah"
                        class="uppercase flex-shrink-0 w-[45%] sm:min-w-max sm:w-[30%] py-1 border-4 border-primary-500 text-primary-500 text-center whitespace-nowrap">
                        EVEREST
                    </button>

                    <button id="monstera-button" type="button" id="fasilitas"
                        class="uppercase flex-shrink-0 w-[45%] sm:min-w-max sm:w-[30%] py-1 text-primary-500 border-4 border-primary-500 hover:bg-primary-500 hover:text-neutral-50 active:bg-primary-400 active:opacity-95 text-center whitespace-nowrap">
                        MONSTERA
                    </button>
                ...
                <div id="everest-index"
                    class="bg-shade-white flex flex-col gap-y-8 min-h-full lg:h-auto justify-center lg:justify-around items-center text-headline4 md:text-headline3 sm:text-center lg:w-[100%] lg:flex-row lg:gap-x-16 lg:gap-y-8 lg:p-0 overflow-hidden">

                    <!-- Gambar tetap di sebelah kiri dengan ukuran asli -->
                    <div id="everest-content"
                        ...
                        <img id="everest-house" src="{{ asset('images/product/house.png') }}"
                            alt="Everest"
                            class="shadow-lg shadow-slate-800 rounded-xl h-full w-full lg:object-cover" />
                        <button id="left-button" type="button"
                            class="absolute top-1/2 -translate-y-1/2 left-0.5  sm:left-[0.5rem] lg:left-[1rem] xl:left-[0.6rem] 2xl:left-[0.8rem]">
                        ...
                        <button id="right-button" type="button"
                            class="absolute top-1/2 -translate-y-1/2 right-0.5 sm:right-[0.5rem] lg:right-[1rem] xl:right-[0.6rem] 2xl:right-[0.8rem]">
                    ...
                    <div
                        class="lg:h-full gap-y-6 lg:gap-12 flex flex-col lg:items-center lg:justify-center sm:w-4/5 lg:w-[60%] xl:w-[70%] overflow-hidden max-w-full">
                        <!-- Judul & Deskripsi -->
                        <div class="flex flex-col gap-y-6 lg:gap-6 w-full max-w-full overflow-hidden">
                            <span
                                class="uppercase block leading-[28px] text-primary-500 font-bold lg:leading-9 sm:text-headline4 sm:leading-6 lg:text-headline4 xl:text-[42px] 2xl:text-headline3 lg:pb-0 lg:text-left text-center break-words w-full">
                                EVEREST
                            </span>
                            <div class="block md:flex md:flex-row md:justify-center lg:block">
                                <p
                                    class="text-justify text-body2 w-full sm:text-body1 xl:text-headline6 2xl:text-headline5 break-words text-wrap sm:font-bold lg:text-justify lg:w-full ">
                        ...
                        <div class="flex gap-y-4 flex-col xl:self-start gap-6 max-w-full">
                            <div
                                class="w-full  text-body1 sm:text-headline6 lg:text-headline6 xl:text-headline5 2xl:text-headline4 break-words">
                                <span
                            ...
                            <div class="flex lg:justify-normal overflow-auto w-full max-w-full pb-2">
                                <div
                                    class="min-w-[40rem] md:min-w-[45rem] lg:min-w-[35rem] max-w-full  font-semibold text-body2 sm:text-body1 lg:text-body1 xl:text-headline6 2xl:text-headline5 text-primary-500 border-2 border-collapse border-primary-500">
                                    <!-- Div Header -->
                                    <div
                                        class="flex justify-center items-center w-full text-shade-white bg-primary-500">
                                    ...
                                    <!-- Div Body -->
                                    <div
                                        class="flex justify-center items-center divide-x-2 divide-primary-500 text-primary-500 bg-shade-white text-center">
                                        <div class="p-1 lg:p-3 break-words flex-1">60m²</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">44m²</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">2</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">2</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">1 Mobil</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="monstera-index"
                    ...
                    <!-- Gambar tetap di sebelah kiri dengan ukuran asli -->
                    <div id="monstera-content"
                        class="py-4 relative flex justify-center aspect-[2/3] sm:aspect-[3/4] lg:aspect-[4/5] max-w-[305px] max-h-[450px] sm:max-w-[380px] md:max-w-[400px] sm:min-h-[550px] lg:max-w-[450px] lg:min-h-[730px] xl:min-h-[800px] sm:animate-veryslow-bounce lg:justify-center lg:items-center lg:order-first overflow-hidden">
                        <img id="monstera-house" src="{{ asset('images/product/monstera.png') }}"
                            alt="Monstera"
                            class="shadow-lg shadow-slate-800 rounded-xl h-full w-full lg:object-cover" />
                            ...
                            <div class="flex lg:justify-normal overflow-auto w-full max-w-full pb-2">
                                <div
                                    ...
                                    <div
                                        class="flex justify-center items-center divide-x-2 divide-primary-500 text-primary-500 bg-shade-white text-center">
                                        <div class="p-1 lg:p-3 break-words flex-1">60m²</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">30m²</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">2</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">1</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">1 Mobil</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="are-index"
                    ...
                    <div id="are-content"
                        class="py-4 relative flex justify-center aspect-[2/3] sm:aspect-[3/4] lg:aspect-[4/5] max-w-[305px] max-h-[450px] sm:max-w-[380px] md:max-w-[400px] sm:min-h-[550px] lg:max-w-[450px] lg:min-h-[730px] xl:min-h-[800px] sm:animate-veryslow-bounce lg:justify-center lg:items-center lg:order-first overflow-hidden">
                        <img id="are-house" src="{{ asset('images/product/are.png') }}"
                            alt="Are"
                            class="shadow-lg shadow-slate-800 rounded-xl h-full w-full lg:object-cover" />
                    ...
                    <div
                        ...
                        <!-- Spesifikasi (Dibawah <p>) -->
                        <div class="flex gap-y-4 flex-col lg:self-start gap-6 max-w-full">
                            <div
                                class="w-full  text-body1 sm:text-headline6 lg:text-headline6 xl:text-headline5 2xl:text-headline4 break-words">
                                <span
                                    class="block text-primary-500 font-bold text-center pb-4 lg:pb-0 lg:text-left">SPESIFIKASI
                            ...
                            <div class="flex lg:justify-normal overflow-auto w-full max-w-full pb-2">
                                <div
                                    ...
                                    <div
                                        class="flex justify-center items-center divide-x-2 divide-primary-500 text-primary-500 bg-shade-white text-center">
                                        <div class="p-1 lg:p-3 break-words flex-1">60m²</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">25m²</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">1</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">1</div>
                                        <div class="p-1 lg:p-3 break-words flex-1">1 Mobil</div>
                                    </div>
