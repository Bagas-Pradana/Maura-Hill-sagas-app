...
<!-- ---------------------------------------------------------------PRODUK KAMI-------------------------------------------- -->
        ...
        <div class="flex flex-col gap-y-8 min-h-full justify-center lg:flex-row lg:justify-between items-center">
            ...
            <div class="w-full md:w-[80%] lg:w-[40%] flex flex-col gap-y-4 lg:gap-y-8">
                ...
                <p class="font-poppins font-bold text-justify text-body2 w-full lg:text-end">
                    Rasakan pengalaman tinggal yang berbeda di <span class="text-primary-500">Maura Hill</span> dengan desain rumah yang memadukan gaya Scandinavian minimalis dan nuansa hangat ala Villa Bali. Perpaduan ini menghadirkan suasana yang elegan, nyaman, dan penuh ketenangan, seperti sedang berlibur di pulau tropis setiap hari.
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="house-content" class="min-h-screen">
            <div class="p-0 relative bg-neutral-200 sm:py-16 flex min-h-full justify-center items-center text-headline4 md:text-headline3 sm:text-center sm:px-4 md:px-9">
                ...
                <div class="px-4 w-full bg-shade-white border-primary-500 pb-6 border-4 flex flex-col gap-y-8 sm:flex-row sm:flex-wrap justify-evenly md:justify-center lg:px-8">
                    <!-- Button -->
                    <div class="flex justify-evenly lg:justify-center gap-4 lg:gap-8 w-full overflow-x-auto sm:px-4 pt-6 font-bold text-headline6 md:text-headline5 lg:text-headline4">
                        <button id="everest-button" type="button" id="rumah" class="flex-shrink-0 min-w-[30%] lg:min-w-[26%] px-4 py-1 border-4 border-primary-500 text-primary-500 text-center whitespace-nowrap">
                            EVEREST
                        </button>
                        
                        <button id="monstera-button" type="button" id="fasilitas" class="flex-shrink-0 min-w-[30%] lg:min-w-[26%] px-4 py-1 text-primary-500 border-4 border-primary-500 hover:bg-primary-500 hover:text-neutral-50 active:bg-primary-400 active:opacity-95 text-center whitespace-nowrap">
                            MONSTERA
                        </button>
                        
                        <button id="are-button" type="button" id="are" class="flex-shrink-0 min-w-[30%] lg:min-w-[26%] px-4 py-1 text-primary-500 border-4 border-primary-500  hover:bg-primary-500 hover:text-neutral-50 active:bg-primary-400 active:opacity-95 text-center whitespace-nowrap">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ARE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </button>
                    </div>
                    <!-- button -->
                    ...
                    <div id="everest-index" class="bg-shade-white flex flex-col gap-y-8 min-h-full lg:h-auto justify-center lg:justify-around items-center text-headline4 md:text-headline3 sm:text-center lg:w-[100%] lg:flex-row lg:gap-x-12 lg:p-0 overflow-hidden">
                        ...
                        <div class="px-4 sm:px-0 lg:h-full gap-y-6 lg:gap-12 flex flex-col lg:items-center lg:justify-center sm:w-[80%] lg:w-[60%] xl:w-[70%] overflow-hidden max-w-full">
                            ...
                            <div class="flex flex-col gap-y-6 lg:gap-6 w-full max-w-full overflow-hidden">
                                <span class="block leading-[28px] text-primary-500 font-bold lg:leading-9 sm:text-headline4 sm:leading-6 lg:text-headline4 xl:text-[42px] lg:pb-0 lg:text-left text-center break-words w-full">
                                    EVEREST
                                </span>
